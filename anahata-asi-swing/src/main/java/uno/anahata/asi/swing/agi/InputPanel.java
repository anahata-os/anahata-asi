...
import uno.anahata.asi.swing.media.util.MicrophonePanel;
...
public class InputPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        this.inputMessagePreview = new UserInputMessagePanel(agiPanel, currentMessage);
    ...
    /**
     * Sends the {@code currentMessage} to the agi asynchronously.
     */
    ...
    private void revertStagedMessage() {
        ...
        if (staged != null) {
            ...
            // Re-render preview
            UserInputMessagePanel newRenderer = new UserInputMessagePanel(agiPanel, this.currentMessage);
