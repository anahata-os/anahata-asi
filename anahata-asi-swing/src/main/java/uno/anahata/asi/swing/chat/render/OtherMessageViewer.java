...
public class OtherMessageViewer extends JScrollPane {
     ...
     */
    public OtherMessageViewer(@NonNull ChatPanel chatPanel, @NonNull AbstractMessage message, 
                             boolean renderPruneButtons, boolean renderRemoveButtons) {
        this.chatPanel = chatPanel;
        this.message = message;

        this.messagePanel = new OtherMessagePanel(chatPanel, message, renderPruneButtons, renderRemoveButtons);
