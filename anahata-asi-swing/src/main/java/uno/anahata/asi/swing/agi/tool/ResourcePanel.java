    ...
    private void updatePreview(AbstractResource<?, ?> res) {
        ...
        try {
            if (res.getContextPosition() == ContextPosition.SYSTEM_INSTRUCTIONS) {
                ...
                previewMsg = new UserMessage(agi);
        ...
        OtherMessageViewer panel = new OtherMessageViewer(parentPanel.getAgiPanel(), previewMsg, false, false);
        panel.render();
