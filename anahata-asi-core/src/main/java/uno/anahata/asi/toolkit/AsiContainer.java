 ...
 * active sessions. This toolkit provides deep visibility into the 'Working Memory' 
 * and 'Long-Term Context' of the ASI across all sessions.
 * 
 * @author anahata
 */
@Slf4j
...
public class AsiContainer extends AnahataToolkit {
     ...
     * 
     * @param sessionId Optional session ID. If null, the current session is used.
