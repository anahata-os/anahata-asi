...
public class CoreContextProvider implements ContextProvider {
    ...
    public List<String> getSystemInstructions() throws Exception {
        ...
        String metadataFormat = "**Metadata Format**\n"
                ...
                + "\n3. **Tool messages**: Tool messages do not contain any metadata (neither for the tool message nor for the function response parts) however, the metadata of the tool's response (the tool execution results) is included in the metadata of the tool call itself (in the preceeding model message)\n"
