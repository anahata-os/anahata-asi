...
public class ToolManager extends BasicPropertyChangeSource implements ContextProvider, Rebindable {
    ...
    public void populateMessage(RagMessage ragMessage) throws Exception {
        ...
        for (AbstractToolkit<?> at: getEnabledToolkits()) {
            ...
            sb.append("\n- Disabled Tools (permission never) *Do not call these tools or they will fail automatically, Ask the user to grant permission if you think need any of these*: ").append(at.getDisabledTools().size());
