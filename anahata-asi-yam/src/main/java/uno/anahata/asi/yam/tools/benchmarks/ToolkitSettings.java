 ...
 * <p>
 * Binds a target {@link AnahataToolkit} class literal to an optional map of simple tool method names
 ...
 * </p>
 *
 * @param toolkitClass The concrete or base Class literal of the toolkit.
...
public record ToolkitSettings(
    ...
    public Map<String, ToolPermission> getResolvedPermissions(Class<?> concreteClass) {
        ...
        String simpleName = (concreteClass != null ? concreteClass : toolkitClass).getSimpleName();
