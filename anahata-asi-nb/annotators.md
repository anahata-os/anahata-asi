...
## Current Strategy
1.  **Project Badges**: Handled exclusively by `AnahataProjectIconAnnotator` (v2) in `anahata-asi-nb`.
...
-   **Attempt 3**: Using `SwingUtilities.invokeLater` with a static listener list in `AnahataProjectIconAnnotator`.
