        ...
        <nav class="${isIndex ? '' : 'nav-solid'}">
            <div class="nav-container container">
                ...
                <div class="nav-links">
                    ...
                    <!-- Docs Dropdown -->
                    <div class="dropdown">
                        <a href="#" class="dropdown-toggle ${(isActive('quickstart.html') || currentPath.includes('apidocs') || isActive('core.html') || isActive('swing.html') || isActive('yam.html') || isActive('gemini.html') || isActive('openai.html') || isActive('anthropic.html') || isActive('novaroute.html') || isActive('ollama.html') || isActive('compatible.html')) ? 'active-link' : ''}">
